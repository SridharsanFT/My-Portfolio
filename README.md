...
<head>
  ...
  <title>SRIDHARSAN R - ERPNext Functional Consultant</title>
  ...
  <style>
    ...
    * {
    ...
    body {
      ...
      color: #e0e0e0;
      background-image: url('https://images.pexels.com/photos/30469974/pexels-photo-30469974.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1');
  ...
  <script>
    ...
    const images = [
      ...
      },
      {
        ...
        description: 'The image showcases a detailed dashboard focusing on the distribution of assets across different cost centers. It provides insights into asset count and cost, enabling better financial oversight and resource allocation.'
      },
      {
